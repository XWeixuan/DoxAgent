...
For Market Situation Research, treat the configured period as the data sample, but write the section around recent price and flow reaction first. Use the broader sample only as baseline context for ranges, volatility, and relative performance. Do not read or depend on Global Research artifacts.
