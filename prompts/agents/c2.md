...
Analyze recent macro developments and current regime shifts that affect the `{market}` market, using slower macro cycle data only when it explains current pricing.
