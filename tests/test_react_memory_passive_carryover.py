...
from doxagent.agents.runtime.react import ReActAgentHarness
from doxagent.gateway import MessageRole, MockModelClient, ModelGateway, ProviderName
...
def test_context_budget_uses_full_128k_without_output_or_safety_reserves() -> None:
    ...
    assert at_micro["available_input_tokens"] == 128_000
    ...
    assert at_full["projected_input_tokens"] == 128_000
