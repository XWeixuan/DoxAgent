        ...
        monitoring_items=[
            MonitoringItem(
                ...
                tool_input={
                    ...
                    "keywords": ["NVDA", "Nvidia", "AI server demand"],
                    "search_terms": ["hyperscaler capex", "MSFT", "AMZN"],
                    "extra": {
                        "expectation_id": "exp_ai_demand",
                        "priority": "high",
                        "trigger_condition": "new confirmed order or cancellation",
                    },
                    "reason": "Track order and cancellation signals for AI demand.",
                    "mode": "merge",
                    "enabled": True,
                },
                reasoning="Track order and cancellation signals for AI demand.",
    ...
    return MonitoringPolicyDocument(
        ...
        direct_trade_rules=[
            MonitoringPolicyRule(
                ...
                trigger={"condition": "confirmed order materially above expectation"},
                trigger_condition="confirmed order materially above expectation",
                confirmation={"market_confirmation": "price reaction is not fully priced in"},
                expectation_id="exp_ai_demand",
                risk_guard={"guardrail": "Do not create broker orders."},
                reasoning="Confirmed orders can change the AI demand expectation.",
                action={
                    "side": "long",
                    "conviction": "medium",
                    "size_bucket": "normal",
                    "note": "Create trade intent only.",
                },
        ...
        push_to_agent_rules=[
            MonitoringPolicyRule(
                ...
                scope={"expectation_unit_id": "exp_ai_demand"},
                trigger={"condition": "ambiguous supplier signal"},
                trigger_condition="ambiguous supplier signal",
                confirmation={"market_confirmation": "direction or price response is ambiguous"},
                expectation_id="exp_ai_demand",
                risk_guard={"guardrail": "Escalate when signal direction is not clear."},
                reasoning="Ambiguous supplier signals need background review.",
                action={
                    "send_to": ["O1", "O4"],
                    "question": "Review narrative and price reaction for this supplier signal.",
                    "priority": "medium",
                },
