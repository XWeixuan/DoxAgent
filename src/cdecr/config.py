...
class CDECRSettings(BaseSettings):
    ...
    model_m2: str = Field(default="qwen3.8-flash", alias="CDECR_MODEL_M2")
    model_m3: str = Field(default="qwen3.8-flash", alias="CDECR_MODEL_M3")
    model_m4: str = Field(default="qwen3.8-flash", alias="CDECR_MODEL_M4")
    ...
    package_v3_model: Literal["qwen3.8-flash"] = Field(
        default="qwen3.8-flash", alias="CDECR_PACKAGE_V3_MODEL"
    )
