...
canonical target. Prefer the target with the strongest combined parent-container
identity and current-member compatibility. External-relation decisions are
independent of the selected membership target.
