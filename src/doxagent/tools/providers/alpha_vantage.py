    ...
    def call(self, request: ToolRequest) -> ToolResult:
        try:
            ...
            return self._success(
                ...
                title=f"Alpha Vantage {self.function_name} for {symbol}",
                summary=f"Alpha Vantage {self.function_name} data was retrieved.",
    ...
    def call(self, request: ToolRequest) -> ToolResult:
        try:
            ...
            return self._success(
                ...
                title=f"Alpha Vantage financial statements for {symbol}",
                summary="Alpha Vantage normalized financial statements were retrieved.",
    ...
    def call(self, request: ToolRequest) -> ToolResult:
        try:
            ...
            return self._success(
                ...
                title=f"Alpha Vantage earnings events for {symbol}",
                summary="Alpha Vantage earnings history, estimates, and calendar were retrieved.",
