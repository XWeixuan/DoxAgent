        ...
        *,
        ...
        context: dict[str, Any] = {
            ...
            "document1_research_focus": {
                "primary_focus": "Prioritize recent company, macro, industry, and price developments, roughly the last 30 days when evidence is available.",
                "background_use": "Use longer history for baseline, cycle, valuation, or structural explanation; do not turn the section into a generic one-year or half-year overview.",
                "claim_discipline": "Do not present older known facts as fresh catalysts unless a recent filing, price reaction, guidance update, policy change, or industry move has renewed their relevance.",
            },
        ...
        *,
        ...
        return {
            ...
            "sections": self._document1_context_sections_from_pack(
                pack, node=node, agent_name=agent_name, task_type=task_type
            ),
        ...
        *,
        ...
        for claim in claims:
            ...
            if not self._include_global_research_section(
                section_key, raw_section, node=node, agent_name=agent_name, task_type=task_type
            ):
                continue
