...
class Document1ValidatorsMixin:
    ...
    def _ensure_global_narrative_section_content(
        self, checkpoint: WorkflowCheckpoint, section: ResearchSection, result: AgentResult
    ) -> ResearchSection:
    ...
    def _global_research_section_fallback_text(
        self, checkpoint: WorkflowCheckpoint, section_key: str, result: AgentResult
    ) -> str:
