    ...
    def __call__(self, task: AgentTask) -> AgentResult:
        ...
        if (
            ...
            return self._result(
                task,
                payload={
                    "answer": "Mock search verification supports the delegated information request.",
                    ...
                    "decisions": [
                        {
                            ...
                            "finding_id": None,
                            "decision": "resolved",
                            "resolution_note": "Mock O1 resolution plan cites existing evidence.",
        ...
        if node == WorkflowNode.REVIEW_EXPECTATION_CONSTRUCTION.value:
            return self._result(
                ...
                payload={
                    ...
                    "delegations": [],
                    "unknowns": [],
                    "rationale": "Mock A1 construction review passed.",
                },
            )
        if node == WorkflowNode.GENERATE_EXPECTATION_DETAILS.value:
            ...
            if isinstance(shell, dict):
                document = document.model_copy(
                    update={
                        "expectation_id": shell.get("expectation_id") or document.expectation_id,
                        ...
                        "why_it_matters": shell.get("why_it_matters") or document.why_it_matters,
        ...
        if (
            ...
            return self._result(
                ...
                payload={
                    ...
                    "findings": [],
                    "objections": [objection.model_dump(mode="json")],
                    "delegations": [delegation.model_dump(mode="json")],
                    "unknowns": [],
                    "rationale": "Mock A1 field review created blocking items.",
                },
        ...
        if node == WorkflowNode.REVIEW_EXPECTATION_FIELDS.value:
            return self._result(
                ...
                payload={
                    ...
                    "delegations": [],
                    "unknowns": [],
                    "rationale": f"Mock {task.agent_name.value} field review passed.",
                },
            )
        ...
        if node == WorkflowNode.GENERATE_GLOBAL_NARRATIVE_REPORT.value:
            return self._result(
                ...
                payload=self._section(
                    task.ticker, AgentName.O1_EXPECTATION_OWNER, "market narrative"
        ...
        if node == WorkflowNode.GENERATE_MONITORING_CONFIG.value:
            ...
            return self._result(
                task, payload={"document_type": "monitoring_config"}, patches=[patch]
            )
        if node == WorkflowNode.GENERATE_MONITORING_POLICY.value:
            ...
            return self._result(
                task, payload={"document_type": "monitoring_policy"}, patches=[patch]
            )
    ...
    def _global_research(self, ticker: str) -> GlobalResearchDocument:
        ...
        return GlobalResearchDocument(
            ...
            fundamental_report=self._section(
                ticker, AgentName.C1_FUNDAMENTAL_RESEARCH, "fundamental"
            ),
