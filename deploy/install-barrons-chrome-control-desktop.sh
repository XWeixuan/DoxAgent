...
install -o "$desktop_user" -g "$desktop_user" -m 0755 \
  "$repo_root/deploy/doxagent-barrons-chrome-control.desktop" \
  "$desktop_home/Desktop/Barrons Chrome Control Test.desktop"

echo "Barrons Chrome control desktop shortcut installed"
