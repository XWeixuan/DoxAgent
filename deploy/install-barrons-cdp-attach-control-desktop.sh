...
install -o "$desktop_user" -g "$desktop_user" -m 0755 \
  "$repo_root/deploy/doxagent-barrons-cdp-attach-control.desktop" \
  "$desktop_home/Desktop/Barrons CDP Attach Test.desktop"

echo "Barrons CDP attach control desktop shortcut installed"
